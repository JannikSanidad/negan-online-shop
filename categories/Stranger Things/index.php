...
<body>
	...
	<section id="shop">
		<div class="container">
			<div id="sidebar">
				<h1>Categories</h1>
				<ul>
					<li><a href="./index.php">Stranger Things</a></li>
			...
			<div id="main">
				...
				<p id="path"><a href="../../index.php">Home</a> / <a href="../../shop.php">Products</a> / Stranger Things</p>
	...
	<?php
		...
		$sql = "SELECT * FROM tbl_product WHERE category = 'Stranger Things'";
