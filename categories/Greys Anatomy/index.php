...
<body>
		...
		<div class="container">
			<div id="sidebar">
				...
				<ul>
					...
					<li><a href="./index.php">Grey's Anatomy</a></li>
			...
			<div id="main">
				...
				<p id="path"><a href="../../index.php">Home</a> / <a href="../../shop.php">Products</a> / Grey's Anatomy</p>
	...
	<?php
		...
		$sql = "SELECT * FROM tbl_product WHERE category = 'Grey's Anatomy";
