...
<body>
		...
		<div class="container">
			<div id="sidebar">
				...
				<ul>
					...
					<li><a href="./index.php">Rick and Morty</a></li>
					<li><a href="../AmericanHorrorStory/index.php">American Horror Story</a></li>
				</ul>
			</div>
			<div id="main">
				<h1 id="title">Products</h1>
				<p id="path"><a href="../../index.php">Home</a> / <a href="../../shop.php">Products</a> / Rick and Morty</p>
	...
	<?php
		...
		$sql = "SELECT * FROM tbl_product WHERE category = 'Rick and Morty'";
