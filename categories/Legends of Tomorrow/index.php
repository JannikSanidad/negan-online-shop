...
<body>
		...
		<div class="container">
			<div id="sidebar">
				...
				<ul>
					...
					<li><a href="./index.php">Legends of Tomorrow</a></li>
			...
			<div id="main">
				...
				<p id="path"><a href="../../index.php">Home</a> / <a href="../../shop.php">Products</a> / Legends of Tomorrow</p>
	...
	<?php
		...
		$sql = "SELECT * FROM tbl_product WHERE category = 'Legends of Tomorrow'";
