...
<body>
		...
		<div class="container">
			<div id="sidebar">
				...
				<ul>
					...
					<li><a href="../Supernatural/index.php">Supernatural</a></li>
					...
					<li><a href="./index.php">American Horror Story</a></li>
				</ul>
			</div>
			<div id="main">
				<h1 id="title">Products</h1>
				<p id="path"><a href="../../index.php">Home</a> / <a href="../../shop.php">Products</a> / American Horror Story</p>
	...
	<?php
		...
		$sql = "SELECT * FROM tbl_product WHERE category = 'American Horror Story'";
