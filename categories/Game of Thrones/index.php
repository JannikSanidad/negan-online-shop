...
<body>
		...
		<div class="container">
			<div id="sidebar">
				...
				<ul>
					...
					<li><a href="./index.php">Game of Thrones</a></li>
			...
			<div id="main">
				...
				<p id="path"><a href="../../index.php">Home</a> / <a href="../../shop.php">Products</a> / Game of Thrones</p>
	...
	<?php
		...
		$sql = "SELECT * FROM tbl_product WHERE category = 'Game of Thrones'";
