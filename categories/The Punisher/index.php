...
<body>
		...
		<div class="container">
			<div id="sidebar">
				...
				<ul>
					...
					<li><a href="./index.php">The Punisher</a></li>
			...
			<div id="main">
				...
				<p id="path"><a href="../../index.php">Home</a> / <a href="../../shop.php">Products</a> / The Punisher</p>
	...
	<?php
		...
		$sql = "SELECT * FROM tbl_product WHERE category = 'The Punisher'";
