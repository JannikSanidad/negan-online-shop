...
<body>
	...
	<section id="shop">
		<div class="container">
			<div id="sidebar">
				<h1>Categories</h1>
				<ul>
					<li><a href="./categories/Stranger Things/index.php">Stranger Things</a></li>
					<li><a href="./categories/Vikings/index.php">Vikings</a></li>
					<li><a href="./categories/The Walking Dead/index.php">The Walking Dead</a></li>
					<li><a href="./categories/The Punisher/index.php">The Punisher</a></li>
					<li><a href="./categories/The Flash/index.php">The Flash</a></li>
					<li><a href="./categories/Game of Thrones/index.php">Game of Thrones</a></li>
					<li><a href="./categories/Riverdale/index.php">Riverdale</a></li>
					<li><a href="./categories/Arrow/index.php">Arrow</a></li>
					<li><a href="./categories/Black Mirror/index.php">Black Mirror</a></li>
					<li><a href="./categories/Supergirl/index.php">Supergirl</a></li>
					<li><a href="./categories/Legends of Tomorrow/index.php">Legends of Tomorrow</a></li>
					<li><a href="./categories/Supernatural/index.php">Supernatural</a></li>
					<li><a href="./categories/Greys Anatomy/index.php">Grey's Anatomy</a></li>
					<li><a href="./categories/Mr. Robot/index.php">Mr. Robot</a></li>
					<li><a href="./categories/Breaking Bad/index.php">Breaking Bad</a></li>
					<li><a href="./categories/Rick and Morty/index.php">Rick and Morty</a></li>
					<li><a href="./categories/AmericanHorrorStory/index.php">American Horror Story</a></li>
				</ul>
			</div>
			<div id="main">
				<h1 id="title">Products</h1>
				<p id="path"><a href="./index.php">Home</a> / Products</a></p>
	...
	<script type="text/javascript">
		...
		function openmodal(container){
			...
			outimg.src = "./categories/" + category + "/img/" + product_id + ".png";
		...
		function createBox(product_id,price,discount,category){
			...
			var str_createBox = "<div class='product'>" +
									"<img src='./categories/" + category + "/img/" + product_id + ".png'>" +
									"<div class='desc'>" +
